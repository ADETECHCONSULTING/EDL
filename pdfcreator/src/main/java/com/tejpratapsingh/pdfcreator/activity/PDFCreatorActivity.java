        ...
        createPDFFromViewList(header, footer, bodyViewList, fileName, new PDFUtil.PDFUtilListener() {
            ...
            public void pdfGenerationSuccess(File savedPDFFile) {
                try {
                    ...
                    textViewPageNumber.setText(String.format(Locale.getDefault(), "%d sur %d", selectedPreviewPage + 1, pagePreviewBitmapList.size()));
                } catch (Exception e) {
                    e.printStackTrace();
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        PDFUtil.getInstance().generatePDF(pdfPageViewList, fileManager.createFileWithName(getApplicationContext(), filename + ".pdf", false).getAbsolutePath(), pdfUtilListener);
                    }
                });
            }
        });
