...
public class PDFViewerActivity extends AppCompatActivity {
    ...
    public static class PdfPageFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater,
            ...
            ((AppCompatTextView) rootView.findViewById(R.id.textViewPdfViewerPageNumber)).setText(String.format(Locale.getDefault(), "%d sur %d", position + 1, pdfBitmapList.size()));
